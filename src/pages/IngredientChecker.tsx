        ...
        <Card className="shadow-medium mb-8">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Button onClick={handleAnalyze} disabled={isLoading || !ingredientsText.trim()} size="lg" className="btn-hero w-full bg-emerald-400 hover:bg-emerald-300 text-gray-950">
